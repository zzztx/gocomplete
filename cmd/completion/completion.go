/*
Copyright 2023 The Author: Jone Zhang.
...
func NewCmdCompletion(ioStreams genericclioptions.IOStreams) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:                 green(i18n.T("Output shell completion code for the specified shell (bash, zsh, fish, or powershell)")),
		Long:                  green(completionLong),
		Example:               green(completionExample),
		Run: func(cmd *cobra.Command, args []string) {
			cmdutil.CheckErr(RunCompletion(ioStreams.Out, cmd, args))
		},
		ValidArgs: shells,
	}
...
func runCompletionFish(out io.Writer, kubectl *cobra.Command) error {
